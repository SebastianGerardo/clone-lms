...
export const LogoutIcon = ({width = 24, height = 24, color = "#292D32"}) => {
    return (
...
export const ArrowDownIcon = ({width = 24, height = 24, color = "#292D32"}) => {
    return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ArrowDownIcon2 = ({width = 24, height = 24, color = "#292D32"}) => {
    return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M19.9201 8.94995L13.4001 15.47C12.6301 16.24 11.3701 16.24 10.6001 15.47L4.08008 8.94995" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
...
export const MoreIcon = ({width = 24, height = 24, color = "#292D32"}) => {
    return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
