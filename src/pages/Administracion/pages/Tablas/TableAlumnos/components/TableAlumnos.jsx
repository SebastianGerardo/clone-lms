...
export const ContentTableAlumnos = ({handleSearch}) => {
...
export const columnsAlumnos = [
  {
    ...
    cell: (row) => (
      <section className="flex items-center justify-start gap-2 min-w-full w-full">
        <div className="w-10 h-w-10 object-contai rounded-md">
          <img src={fotoAlumno} alt="" className="w-full h-full rounded-md" />
        </div>
        <p className="text-gray-500 font-bold w-full truncate text-start">
          {row.nombreAlumno}
        </p>
      </section>
    ),
  ...
  },
  {
    ...
    cell: (row) => (
      <p className="mt-[0.10rem] font-semibold">{row.dniAlumno}</p>
    ),
    sortable: true,
    center: true,
  },
  ...
  {
    name: <NameTable name="Aula" />,
    cell: (row) => {
      return <p className="mt-[0.10rem] font-semibold">{row.aula}</p>;
    },
    sortable: true,
    width: "10rem",
    center: true,
  ...
  {
    name: <NameTable name="Grado" />,
    cell: (row) => (
      <p className="mt-[0.10rem] font-semibold">{row.gradoAlumno} {row.nivelAlumno}</p>
    ),
    sortable: true,
    center: true,
  },
  {
    ...
    cell: (row) => (
      <NavLink
        key={row.id}
        state={{logged: true}}
        to={`/dashboard/administracion/edit/alumno/${row.dniAlumno}`}
